...
from helomi.cli.logger import _ensure_component, configure_console_logger
...
from helomi.speech.events import SpeechReady, WakeWordObserved
...
def test_console_logger_adds_default_component() -> None:
    ...
    assert record["extra"] == {"component": "Helomi"}
    ...
    assert any("Helomi:ready" in message for message in messages)

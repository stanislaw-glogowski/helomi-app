...
from helomi.speech.capture import get_vad_model
from helomi.speech.capture.adapters.mlx_silero_vad import SileroVADModel
from helomi.speech.capture.config import VADSettings
from helomi.speech.synthesis.adapters import get_tts_model
from helomi.speech.synthesis.adapters.mlx_chatterbox import MLXChatterboxModel
from helomi.speech.synthesis.adapters.piper import PiperModel
from helomi.speech.synthesis.config import (
...
from helomi.speech.transcription.adapters import get_stt_model
from helomi.speech.transcription.adapters.mlx_parakeet_tdt import ParakeetTDTModel
from helomi.speech.transcription.adapters.mlx_qwen3_asr import Qwen3ASRModel
from helomi.speech.transcription.adapters.mlx_whisper import WhisperModel
...
def test_piper_adapter_contract(monkeypatch: pytest.MonkeyPatch) -> None:
    import helomi.speech.synthesis.adapters.piper as piper_module

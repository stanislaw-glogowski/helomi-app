...
from helomi.speech.audio.adapters.avfaudio import AVFAudioDriver
from helomi.speech.audio.adapters.avfaudio.process import AVFAudioProcess
from helomi.speech.audio.adapters.avfaudio.protocol import (
    AudioDevicesPacket,
    AudioPacket,
    MessageKind,
    PlaybackStatus,
...
def test_avfaudio_process_lifecycle() -> None:
    helper = Path(__file__).parents[2] / "fixtures" / "fake_avfaudio_helper.py"

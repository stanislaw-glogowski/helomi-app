...
from helomi.common.components import AbstractAsyncService, AbstractResource
from helomi.common.events import Event, EventBus
from helomi.common.logger import bind_logger
...
def test_resource_context_and_bound_logger() -> None:
    ...
    logger = bind_logger("worker", "helomi")
    assert logger._options[8]["component"] == "worker(helomi)"

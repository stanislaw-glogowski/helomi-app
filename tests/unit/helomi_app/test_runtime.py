...
async def test_runtime_initialization_and_components(temp_helomi_store: Path) -> None:
    ...
    with (
        patch("helomi_app.runtime.get_audio_driver", return_value=MockAudioDriver()),
        patch("helomi_app.runtime.get_stt_adapter") as mock_stt,
        patch("helomi_app.runtime.get_tts_adapter") as mock_tts,
        patch("helomi_app.runtime.get_turn_adapter") as mock_turn,
        patch("helomi_app.runtime.get_vad_adapter") as mock_vad,
        patch("helomi_app.runtime.get_wakeword_adapter") as mock_ww,
    ):

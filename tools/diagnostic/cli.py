...
from helomi.speech.audio.adapters import get_audio_driver
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Helomi diagnostics by type.")
    parser.add_argument("--type", choices=("audio",), required=True)
